...
{viewerjumpto "Syntax" "generateODT##syntax"}{...}
{viewerjumpto "Description" "generateODT##description"}{...}
{viewerjumpto "Options" "generateODT##options"}{...}
{viewerjumpto "Remarks" "generateODT##remarks"}{...}
{viewerjumpto "Examples" "generateODT##examples"}{...}
{title:Title}
{phang}
{bf:generateODT} {hline 2} a command to setup working directory and necessary files and folder for anonymization
